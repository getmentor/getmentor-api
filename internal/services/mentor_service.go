...
// MentorServiceInterface defines the interface for mentor business logic operations.
...
func NewMentorService(repo repository.MentorRepositoryInterface, cfg *config.Config) MentorServiceInterface {
